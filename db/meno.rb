...
msg18 = Scon3.messages.create({
    ...
    msg18.update({updated_at: 8.years.ago})
      ...
      Scon4 = soc.conversations.create(title: "I should say that health is", meta_conversation: MetCon4)
      Mcon4 = meno.conversations.create(title: "I should say that health is", meta_conversation: MetCon4)
      Bcon4 = boy.conversations.create(title: "I should say that health is", meta_conversation: MetCon4)
      Acon4 = anytus.conversations.create(title: "I should say that health is", meta_conversation: MetCon4 )

body_str = <<-BODY 
 I should say that health is the same, both in man and woman.
BODY

msg19 = Mcon4.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 8.years.ago
    ...
    msg19.update({updated_at: 8.years.ago})
      ...
      Scon5 = soc.conversations.create(title: "And is not this true of", meta_conversation: MetCon5)
      Mcon5 = meno.conversations.create(title: "And is not this true of", meta_conversation: MetCon5)
      Bcon5 = boy.conversations.create(title: "And is not this true of", meta_conversation: MetCon5)
      Acon5 = anytus.conversations.create(title: "And is not this true of", meta_conversation: MetCon5 )
...
msg21 = Mcon5.messages.create({
    ...
    msg21.update({updated_at: 8.years.ago})
      ...
      Scon6 = soc.conversations.create(title: "And will not virtue, as virtue,", meta_conversation: MetCon6)
      Mcon6 = meno.conversations.create(title: "And will not virtue, as virtue,", meta_conversation: MetCon6)
      Bcon6 = boy.conversations.create(title: "And will not virtue, as virtue,", meta_conversation: MetCon6)
      Acon6 = anytus.conversations.create(title: "And will not virtue, as virtue,", meta_conversation: MetCon6 )
...
msg28 = Scon6.messages.create({
    ...
    msg28.update({updated_at: 7.years.ago})
      ...
      Scon7 = soc.conversations.create(title: "Certainly.", meta_conversation: MetCon7)
      Mcon7 = meno.conversations.create(title: "Certainly.", meta_conversation: MetCon7)
      Bcon7 = boy.conversations.create(title: "Certainly.", meta_conversation: MetCon7)
      Acon7 = anytus.conversations.create(title: "Certainly.", meta_conversation: MetCon7 )
...
msg39 = Mcon7.messages.create({
    ...
    msg39.send_msg
    msg39.update({updated_at: 6.years.ago})
...
msg46 = Scon7.messages.create({
    ...
    msg46.update({updated_at: 5.years.ago})
      ...
      Scon8 = soc.conversations.create(title: "Yes, Socrates; I agree there; for", meta_conversation: MetCon8)
      Mcon8 = meno.conversations.create(title: "Yes, Socrates; I agree there; for", meta_conversation: MetCon8)
      Bcon8 = boy.conversations.create(title: "Yes, Socrates; I agree there; for", meta_conversation: MetCon8)
      Acon8 = anytus.conversations.create(title: "Yes, Socrates; I agree there; for", meta_conversation: MetCon8 )

body_str = <<-BODY 
 Yes, Socrates; I agree there; for justice is virtue.
BODY

msg47 = Mcon8.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 5.years.ago
...
msg54 = Scon8.messages.create({
    ...
    msg54.update({updated_at: 5.years.ago})
      ...
      Scon9 = soc.conversations.create(title: "Why, Socrates, even now I am", meta_conversation: MetCon9)
      Mcon9 = meno.conversations.create(title: "Why, Socrates, even now I am", meta_conversation: MetCon9)
      Bcon9 = boy.conversations.create(title: "Why, Socrates, even now I am", meta_conversation: MetCon9)
      Acon9 = anytus.conversations.create(title: "Why, Socrates, even now I am", meta_conversation: MetCon9 )
...
msg100 = Scon9.messages.create({
    ...
    msg100.send_msg
    msg100.update({updated_at: 1.years.ago})
...
msg101 = Mcon9.messages.create({
    ...
    msg101.send_msg
    msg101.update({updated_at: 1.years.ago})
...
msg102 = Scon9.messages.create({
    ...
    msg102.send_msg
    msg102.update({updated_at: 1.years.ago})
...
msg104 = Scon9.messages.create({
    ...
    msg104.update({updated_at: 1.years.ago})
      ...
      Scon10 = soc.conversations.create(title: "True.", meta_conversation: MetCon10)
      Mcon10 = meno.conversations.create(title: "True.", meta_conversation: MetCon10)
      Bcon10 = boy.conversations.create(title: "True.", meta_conversation: MetCon10)
      Acon10 = anytus.conversations.create(title: "True.", meta_conversation: MetCon10 )

body_str = <<-BODY 
 True.
BODY

msg105 = Mcon10.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 1.years.ago
...
msg109 = Mcon10.messages.create({
    ...
    msg109.send_msg
    msg109.update({updated_at: 12.months.ago})
...
msg126 = Scon10.messages.create({
    ...
    msg126.update({updated_at: 10.months.ago})
      ...
      Scon11 = soc.conversations.create(title: "Certainly I do.", meta_conversation: MetCon11)
      Mcon11 = meno.conversations.create(title: "Certainly I do.", meta_conversation: MetCon11)
      Bcon11 = boy.conversations.create(title: "Certainly I do.", meta_conversation: MetCon11)
      Acon11 = anytus.conversations.create(title: "Certainly I do.", meta_conversation: MetCon11 )

body_str = <<-BODY 
 Certainly I do.
BODY

msg127 = Mcon11.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 10.months.ago
...
msg130 = Scon11.messages.create({
    ...
    msg130.update({updated_at: 9.months.ago})
      ...
      Scon12 = soc.conversations.create(title: "There are some who think that", meta_conversation: MetCon12)
      Mcon12 = meno.conversations.create(title: "There are some who think that", meta_conversation: MetCon12)
      Bcon12 = boy.conversations.create(title: "There are some who think that", meta_conversation: MetCon12)
      Acon12 = anytus.conversations.create(title: "There are some who think that", meta_conversation: MetCon12 )
...
msg164 = Scon14.messages.create({
    ...
    msg164.send_msg
    msg164.update({updated_at: 6.months.ago})
...
msg165 = Mcon14.messages.create({
    ...
    msg165.send_msg
    msg165.update({updated_at: 6.months.ago})
      ...
      Scon15 = soc.conversations.create(title: "And were we not saying just", meta_conversation: MetCon15)
      Mcon15 = meno.conversations.create(title: "And were we not saying just", meta_conversation: MetCon15)
      Bcon15 = boy.conversations.create(title: "And were we not saying just", meta_conversation: MetCon15)
      Acon15 = anytus.conversations.create(title: "And were we not saying just", meta_conversation: MetCon15 )
...
msg173 = Mcon15.messages.create({
    ...
    msg173.update({updated_at: 6.months.ago})
      ...
      Scon16 = soc.conversations.create(title: "What of that! Why, did not", meta_conversation: MetCon16)
      Mcon16 = meno.conversations.create(title: "What of that! Why, did not", meta_conversation: MetCon16)
      Bcon16 = boy.conversations.create(title: "What of that! Why, did not", meta_conversation: MetCon16)
      Acon16 = anytus.conversations.create(title: "What of that! Why, did not", meta_conversation: MetCon16 )
...
msg174 = Scon16.messages.create({
    ...
    msg174.update({updated_at: 6.months.ago})
      ...
      Scon17 = soc.conversations.create(title: "No; I do not say that", meta_conversation: MetCon17)
      Mcon17 = meno.conversations.create(title: "No; I do not say that", meta_conversation: MetCon17)
      Bcon17 = boy.conversations.create(title: "No; I do not say that", meta_conversation: MetCon17)
      Acon17 = anytus.conversations.create(title: "No; I do not say that", meta_conversation: MetCon17 )

body_str = <<-BODY 
 No; I do not say that he can.
BODY

msg175 = Mcon17.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 6.months.ago
...
msg182 = Scon17.messages.create({
    ...
    msg182.update({updated_at: 6.months.ago})
      ...
      Scon18 = soc.conversations.create(title: "What do you mean, Socrates?", meta_conversation: MetCon18)
      Mcon18 = meno.conversations.create(title: "What do you mean, Socrates?", meta_conversation: MetCon18)
      Bcon18 = boy.conversations.create(title: "What do you mean, Socrates?", meta_conversation: MetCon18)
      Acon18 = anytus.conversations.create(title: "What do you mean, Socrates?", meta_conversation: MetCon18 )

body_str = <<-BODY 
 What do you mean, Socrates?
BODY

msg183 = Mcon18.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}",
    body: body_str,
...
msg194 = Scon18.messages.create({
    ...
    msg194.update({updated_at: 5.months.ago})
      ...
      Scon19 = soc.conversations.create(title: "What was it? and who were", meta_conversation: MetCon19)
      Mcon19 = meno.conversations.create(title: "What was it? and who were", meta_conversation: MetCon19)
      Bcon19 = boy.conversations.create(title: "What was it? and who were", meta_conversation: MetCon19)
      Acon19 = anytus.conversations.create(title: "What was it? and who were", meta_conversation: MetCon19 )

body_str = <<-BODY 
 What was it? and who were they?
BODY

msg195 = Mcon19.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 5.months.ago
...
msg196 = Scon19.messages.create({
    ...
    msg196.send_msg
    msg196.update({updated_at: 5.months.ago})
...
msg197 = Mcon19.messages.create({
    ...
    msg197.send_msg
    msg197.update({updated_at: 5.months.ago})
...
msg207 = Bcon19.messages.create({
    source_address: "boy#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 4.months.ago
    })

    msg207.send_msg
    msg207.update({updated_at: 4.months.ago})
...
msg219 = Bcon19.messages.create({
    ...
    msg219.update({updated_at: 3.months.ago})
      ...
      Scon20 = soc.conversations.create(title: "And how many are twice two", meta_conversation: MetCon20)
      Mcon20 = meno.conversations.create(title: "And how many are twice two", meta_conversation: MetCon20)
      Bcon20 = boy.conversations.create(title: "And how many are twice two", meta_conversation: MetCon20)
      Acon20 = anytus.conversations.create(title: "And how many are twice two", meta_conversation: MetCon20 )

body_str = <<-BODY 
 And how many are twice two feet? count and tell me.
BODY

msg220 = Scon20.messages.create({
    source_address: "daemonic#{EMAIL_SIGNATURE}",
    target_address: "boy#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
...
msg227 = Bcon20.messages.create({
    ...
    msg227.update({updated_at: 1.months.ago})
      ...
      Scon21 = soc.conversations.create(title: "Do you observe, Meno, that I", meta_conversation: MetCon21)
      Mcon21 = meno.conversations.create(title: "Do you observe, Meno, that I", meta_conversation: MetCon21)
      Bcon21 = boy.conversations.create(title: "Do you observe, Meno, that I", meta_conversation: MetCon21)
      Acon21 = anytus.conversations.create(title: "Do you observe, Meno, that I", meta_conversation: MetCon21 )
...
msg229 = Mcon21.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, boy#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 1.months.ago
    })
...
msg242 = Scon21.messages.create({
    ...
    msg242.update({updated_at: 11.days.ago})
      ...
      Scon22 = soc.conversations.create(title: "True.", meta_conversation: MetCon22)
      Mcon22 = meno.conversations.create(title: "True.", meta_conversation: MetCon22)
      Bcon22 = boy.conversations.create(title: "True.", meta_conversation: MetCon22)
      Acon22 = anytus.conversations.create(title: "True.", meta_conversation: MetCon22 )

body_str = <<-BODY 
 True.
BODY

msg243 = Bcon22.messages.create({
    source_address: "boy#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 11.days.ago
...
msg260 = Scon22.messages.create({
    ...
    msg260.update({updated_at: 10.days.ago})
      ...
      Scon23 = soc.conversations.create(title: "Yes; I think so.", meta_conversation: MetCon23)
      Mcon23 = meno.conversations.create(title: "Yes; I think so.", meta_conversation: MetCon23)
      Bcon23 = boy.conversations.create(title: "Yes; I think so.", meta_conversation: MetCon23)
      Acon23 = anytus.conversations.create(title: "Yes; I think so.", meta_conversation: MetCon23 )

body_str = <<-BODY 
 Yes; I think so.
BODY

msg261 = Bcon23.messages.create({
    source_address: "boy#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 10.days.ago
...
msg299 = Bcon23.messages.create({
    ...
    msg299.send_msg
    msg299.update({updated_at: 7.days.ago})
...
msg300 = Scon23.messages.create({
    ...
    msg300.send_msg
    msg300.update({updated_at: 7.days.ago})
...
msg301 = Bcon23.messages.create({
    ...
    msg301.send_msg
    msg301.update({updated_at: 7.days.ago})
...
msg307 = Bcon23.messages.create({
    ...
    msg307.send_msg
    msg307.update({updated_at: 6.days.ago})
...
msg308 = Scon23.messages.create({
    ...
    msg308.send_msg
    msg308.update({updated_at: 6.days.ago})
...
msg309 = Bcon23.messages.create({
    ...
    msg309.send_msg
    msg309.update({updated_at: 6.days.ago})
...
msg310 = Scon23.messages.create({
    ...
    msg310.send_msg
    msg310.update({updated_at: 6.days.ago})
...
msg311 = Bcon23.messages.create({
    ...
    msg311.send_msg
    msg311.update({updated_at: 6.days.ago})
...
msg321 = Bcon23.messages.create({
    ...
    msg321.send_msg
    msg321.update({updated_at: 5.days.ago})
...
msg322 = Scon23.messages.create({
    ...
    msg322.send_msg
    msg322.update({updated_at: 5.days.ago})
...
msg323 = Bcon23.messages.create({
    ...
    msg323.send_msg
    msg323.update({updated_at: 5.days.ago})
...
msg324 = Scon23.messages.create({
    ...
    msg324.send_msg
    msg324.update({updated_at: 5.days.ago})
      ...
      Scon24 = soc.conversations.create(title: "Yes.", meta_conversation: MetCon24)
      Mcon24 = meno.conversations.create(title: "Yes.", meta_conversation: MetCon24)
      Bcon24 = boy.conversations.create(title: "Yes.", meta_conversation: MetCon24)
      Acon24 = anytus.conversations.create(title: "Yes.", meta_conversation: MetCon24 )

body_str = <<-BODY 
 Yes.
BODY

msg325 = Bcon24.messages.create({
    source_address: "boy#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 5.days.ago
...
msg331 = Mcon24.messages.create({
    ...
    msg331.send_msg
    msg331.update({updated_at: 4.days.ago})
...
msg332 = Scon24.messages.create({
    ...
    msg332.send_msg
    msg332.update({updated_at: 4.days.ago})
...
msg333 = Mcon24.messages.create({
    ...
    msg333.send_msg
    msg333.update({updated_at: 4.days.ago})
      ...
      Scon25 = soc.conversations.create(title: "Then he who does not know", meta_conversation: MetCon25)
      Mcon25 = meno.conversations.create(title: "Then he who does not know", meta_conversation: MetCon25)
      Bcon25 = boy.conversations.create(title: "Then he who does not know", meta_conversation: MetCon25)
      Acon25 = anytus.conversations.create(title: "Then he who does not know", meta_conversation: MetCon25 )
...
msg334 = Scon25.messages.create({
    ...
    msg334.send_msg
    msg334.update({updated_at: 4.days.ago})
...
msg335 = Mcon25.messages.create({
    ...
    msg335.send_msg
    msg335.update({updated_at: 4.days.ago})
      ...
      Scon26 = soc.conversations.create(title: "And at present these notions have", meta_conversation: MetCon26)
      Mcon26 = meno.conversations.create(title: "And at present these notions have", meta_conversation: MetCon26)
      Bcon26 = boy.conversations.create(title: "And at present these notions have", meta_conversation: MetCon26)
      Acon26 = anytus.conversations.create(title: "And at present these notions have", meta_conversation: MetCon26 )
...
msg336 = Scon26.messages.create({
    ...
    msg336.send_msg
    msg336.update({updated_at: 4.days.ago})
...
msg337 = Mcon26.messages.create({
    ...
    msg337.send_msg
    msg337.update({updated_at: 4.days.ago})
...
msg342 = Scon26.messages.create({
    ...
    msg342.send_msg
    msg342.update({updated_at: 3.days.ago})
...
msg343 = Mcon26.messages.create({
    ...
    msg343.send_msg
    msg343.update({updated_at: 3.days.ago})
...
msg344 = Scon26.messages.create({
    ...
    msg344.send_msg
    msg344.update({updated_at: 3.days.ago})
...
msg345 = Mcon26.messages.create({
    ...
    msg345.send_msg
    msg345.update({updated_at: 3.days.ago})
      ...
      Scon27 = soc.conversations.create(title: "And yet he has the knowledge?", meta_conversation: MetCon27)
      Mcon27 = meno.conversations.create(title: "And yet he has the knowledge?", meta_conversation: MetCon27)
      Bcon27 = boy.conversations.create(title: "And yet he has the knowledge?", meta_conversation: MetCon27)
      Acon27 = anytus.conversations.create(title: "And yet he has the knowledge?", meta_conversation: MetCon27 )

body_str = <<-BODY 
 And yet he has the knowledge?
BODY

msg346 = Scon27.messages.create({
    source_address: "daemonic#{EMAIL_SIGNATURE}",
    target_address: "boy#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 3.days.ago
    ...
    msg346.send_msg
    msg346.update({updated_at: 3.days.ago})
...
msg347 = Mcon27.messages.create({
    ...
    msg347.send_msg
    msg347.update({updated_at: 3.days.ago})
...
msg348 = Scon27.messages.create({
    ...
    msg348.send_msg
    msg348.update({updated_at: 3.days.ago})
      ...
      Scon28 = soc.conversations.create(title: "Clearly he must.", meta_conversation: MetCon28)
      Mcon28 = meno.conversations.create(title: "Clearly he must.", meta_conversation: MetCon28)
      Bcon28 = boy.conversations.create(title: "Clearly he must.", meta_conversation: MetCon28)
      Acon28 = anytus.conversations.create(title: "Clearly he must.", meta_conversation: MetCon28 )

body_str = <<-BODY 
 Clearly he must.
BODY

msg349 = Mcon28.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, boy#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 3.days.ago
    ...
    msg349.send_msg
    msg349.update({updated_at: 3.days.ago})
...
msg350 = Scon28.messages.create({
    ...
    msg350.send_msg
    msg350.update({updated_at: 3.days.ago})
...
msg353 = Mcon28.messages.create({
    ...
    msg353.send_msg
    msg353.update({updated_at: 2.days.ago})
...
msg354 = Scon28.messages.create({
    ...
    msg354.send_msg
    msg354.update({updated_at: 2.days.ago})
...
msg355 = Mcon28.messages.create({
    ...
    msg355.send_msg
    msg355.update({updated_at: 2.days.ago})
...
msg356 = Scon28.messages.create({
    ...
    msg356.send_msg
    msg356.update({updated_at: 2.days.ago})
...
msg357 = Mcon28.messages.create({
    ...
    msg357.send_msg
    msg357.update({updated_at: 2.days.ago})
...
msg358 = Scon28.messages.create({
    ...
    msg358.send_msg
    msg358.update({updated_at: 2.days.ago})
...
msg359 = Mcon28.messages.create({
    ...
    msg359.send_msg
    msg359.update({updated_at: 2.days.ago})
...
msg360 = Scon28.messages.create({
    ...
    msg360.send_msg
    msg360.update({updated_at: 2.days.ago})
      ...
      Scon29 = soc.conversations.create(title: "I agree.", meta_conversation: MetCon29)
      Mcon29 = meno.conversations.create(title: "I agree.", meta_conversation: MetCon29)
      Bcon29 = boy.conversations.create(title: "I agree.", meta_conversation: MetCon29)
      Acon29 = anytus.conversations.create(title: "I agree.", meta_conversation: MetCon29 )

body_str = <<-BODY 
 I agree.
BODY

msg361 = Mcon29.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, boy#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 2.days.ago
    ...
    msg361.send_msg
    msg361.update({updated_at: 2.days.ago})
...
msg364 = Scon29.messages.create({
    ...
    msg364.send_msg
    msg364.update({updated_at: 1.days.ago})
...
msg365 = Mcon29.messages.create({
    ...
    msg365.send_msg
    msg365.update({updated_at: 1.days.ago})
...
msg366 = Scon29.messages.create({
    ...
    msg366.send_msg
    msg366.update({updated_at: 1.days.ago})
...
msg367 = Mcon29.messages.create({
    ...
    msg367.send_msg
    msg367.update({updated_at: 1.days.ago})
...
msg368 = Scon29.messages.create({
    ...
    msg368.send_msg
    msg368.update({updated_at: 1.days.ago})
...
msg369 = Mcon29.messages.create({
    ...
    msg369.send_msg
    msg369.update({updated_at: 1.days.ago})
...
msg370 = Scon29.messages.create({
    ...
    msg370.send_msg
    msg370.update({updated_at: 1.days.ago})
...
msg371 = Mcon29.messages.create({
    ...
    msg371.send_msg
    msg371.update({updated_at: 1.days.ago})
...
msg372 = Scon29.messages.create({
    ...
    msg372.send_msg
    msg372.update({updated_at: 1.days.ago})
...
msg375 = Mcon29.messages.create({
    ...
    msg375.send_msg
    msg375.update({updated_at: 12.hours.ago})
...
msg376 = Scon29.messages.create({
    ...
    msg376.send_msg
    msg376.update({updated_at: 11.hours.ago})
...
msg377 = Mcon29.messages.create({
    ...
    msg377.send_msg
    msg377.update({updated_at: 11.hours.ago})
...
msg378 = Scon29.messages.create({
    ...
    msg378.send_msg
    msg378.update({updated_at: 11.hours.ago})
...
msg379 = Mcon29.messages.create({
    ...
    msg379.send_msg
    msg379.update({updated_at: 11.hours.ago})
...
msg380 = Scon29.messages.create({
    ...
    msg380.send_msg
    msg380.update({updated_at: 11.hours.ago})
...
msg381 = Mcon29.messages.create({
    ...
    msg381.send_msg
    msg381.update({updated_at: 11.hours.ago})
...
msg382 = Scon29.messages.create({
    ...
    msg382.send_msg
    msg382.update({updated_at: 11.hours.ago})
...
msg383 = Mcon29.messages.create({
    ...
    msg383.send_msg
    msg383.update({updated_at: 11.hours.ago})
      ...
      Scon30 = soc.conversations.create(title: "Next, let us consider the goods", meta_conversation: MetCon30)
      Mcon30 = meno.conversations.create(title: "Next, let us consider the goods", meta_conversation: MetCon30)
      Bcon30 = boy.conversations.create(title: "Next, let us consider the goods", meta_conversation: MetCon30)
      Acon30 = anytus.conversations.create(title: "Next, let us consider the goods", meta_conversation: MetCon30 )
...
msg384 = Scon30.messages.create({
    ...
    msg384.send_msg
    msg384.update({updated_at: 11.hours.ago})
...
msg385 = Mcon30.messages.create({
    ...
    msg385.send_msg
    msg385.update({updated_at: 11.hours.ago})
...
msg386 = Scon30.messages.create({
    ...
    msg386.send_msg
    msg386.update({updated_at: 10.hours.ago})
...
msg387 = Mcon30.messages.create({
    ...
    msg387.send_msg
    msg387.update({updated_at: 10.hours.ago})
...
msg388 = Scon30.messages.create({
    ...
    msg388.send_msg
    msg388.update({updated_at: 10.hours.ago})
...
msg389 = Mcon30.messages.create({
    ...
    msg389.send_msg
    msg389.update({updated_at: 10.hours.ago})
...
msg390 = Scon30.messages.create({
    ...
    msg390.send_msg
    msg390.update({updated_at: 10.hours.ago})
...
msg391 = Mcon30.messages.create({
    ...
    msg391.send_msg
    msg391.update({updated_at: 10.hours.ago})
...
msg392 = Scon30.messages.create({
    ...
    msg392.send_msg
    msg392.update({updated_at: 10.hours.ago})
...
msg393 = Mcon30.messages.create({
    ...
    msg393.send_msg
    msg393.update({updated_at: 10.hours.ago})
...
msg394 = Scon30.messages.create({
    ...
    msg394.send_msg
    msg394.update({updated_at: 10.hours.ago})
...
msg395 = Mcon30.messages.create({
    ...
    msg395.send_msg
    msg395.update({updated_at: 10.hours.ago})
...
msg396 = Scon30.messages.create({
    ...
    msg396.send_msg
    msg396.update({updated_at: 10.hours.ago})
...
msg397 = Mcon30.messages.create({
    ...
    msg397.send_msg
    msg397.update({updated_at: 10.hours.ago})
      ...
      Scon31 = soc.conversations.create(title: "And is not this universally true", meta_conversation: MetCon31)
      Mcon31 = meno.conversations.create(title: "And is not this universally true", meta_conversation: MetCon31)
      Bcon31 = boy.conversations.create(title: "And is not this universally true", meta_conversation: MetCon31)
      Acon31 = anytus.conversations.create(title: "And is not this universally true", meta_conversation: MetCon31 )
...
msg398 = Scon31.messages.create({
    ...
    msg398.send_msg
    msg398.update({updated_at: 10.hours.ago})
...
msg401 = Mcon31.messages.create({
    ...
    msg401.update({updated_at: 10.hours.ago})
      ...
      Scon32 = soc.conversations.create(title: "But if this is true, then", meta_conversation: MetCon32)
      Mcon32 = meno.conversations.create(title: "But if this is true, then", meta_conversation: MetCon32)
      Bcon32 = boy.conversations.create(title: "But if this is true, then", meta_conversation: MetCon32)
      Acon32 = anytus.conversations.create(title: "But if this is true, then", meta_conversation: MetCon32 )

body_str = <<-BODY 
 But if this is true, then the good are not by nature good?
BODY

msg402 = Scon32.messages.create({
    source_address: "daemonic#{EMAIL_SIGNATURE}",
    target_address: "boy#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 10.hours.ago
...
msg403 = Mcon32.messages.create({
    ...
    msg403.send_msg
    msg403.update({updated_at: 9.hours.ago})
...
msg404 = Scon32.messages.create({
    ...
    msg404.send_msg
    msg404.update({updated_at: 9.hours.ago})
...
msg405 = Mcon32.messages.create({
    ...
    msg405.send_msg
    msg405.update({updated_at: 9.hours.ago})
      ...
      Scon33 = soc.conversations.create(title: "But if the good are not", meta_conversation: MetCon33)
      Mcon33 = meno.conversations.create(title: "But if the good are not", meta_conversation: MetCon33)
      Bcon33 = boy.conversations.create(title: "But if the good are not", meta_conversation: MetCon33)
      Acon33 = anytus.conversations.create(title: "But if the good are not", meta_conversation: MetCon33 )
...
msg406 = Scon33.messages.create({
    ...
    msg406.send_msg
    msg406.update({updated_at: 9.hours.ago})
...
msg407 = Mcon33.messages.create({
    ...
    msg407.send_msg
    msg407.update({updated_at: 9.hours.ago})
...
msg408 = Scon33.messages.create({
    ...
    msg408.send_msg
    msg408.update({updated_at: 9.hours.ago})
...
msg409 = Mcon33.messages.create({
    ...
    msg409.send_msg
    msg409.update({updated_at: 9.hours.ago})
...
msg410 = Scon33.messages.create({
    ...
    msg410.send_msg
    msg410.update({updated_at: 9.hours.ago})
      ...
      Scon34 = soc.conversations.create(title: "Well; and why are you so", meta_conversation: MetCon34)
      Mcon34 = meno.conversations.create(title: "Well; and why are you so", meta_conversation: MetCon34)
      Bcon34 = boy.conversations.create(title: "Well; and why are you so", meta_conversation: MetCon34)
      Acon34 = anytus.conversations.create(title: "Well; and why are you so", meta_conversation: MetCon34 )
...
msg411 = Mcon34.messages.create({
    ...
    msg411.send_msg
    msg411.update({updated_at: 9.hours.ago})
...
msg412 = Scon34.messages.create({
    ...
    msg412.send_msg
    msg412.update({updated_at: 9.hours.ago})
...
msg414 = Scon34.messages.create({
    ...
    msg414.send_msg
    msg414.update({updated_at: 8.hours.ago})
...
msg415 = Mcon34.messages.create({
    ...
    msg415.send_msg
    msg415.update({updated_at: 8.hours.ago})
...
msg416 = Scon34.messages.create({
    ...
    msg416.send_msg
    msg416.update({updated_at: 8.hours.ago})
...
msg417 = Acon34.messages.create({
    ...
    msg417.send_msg
    msg417.update({updated_at: 8.hours.ago})
...
msg418 = Scon34.messages.create({
    ...
    msg418.send_msg
    msg418.update({updated_at: 8.hours.ago})
...
msg419 = Acon34.messages.create({
    ...
    msg419.send_msg
    msg419.update({updated_at: 8.hours.ago})
...
msg420 = Scon34.messages.create({
    ...
    msg420.send_msg
    msg420.update({updated_at: 8.hours.ago})
...
msg421 = Acon34.messages.create({
    ...
    msg421.send_msg
    msg421.update({updated_at: 8.hours.ago})
...
msg422 = Scon34.messages.create({
    ...
    msg422.send_msg
    msg422.update({updated_at: 8.hours.ago})
...
msg423 = Acon34.messages.create({
    ...
    msg423.send_msg
    msg423.update({updated_at: 8.hours.ago})
...
msg424 = Scon34.messages.create({
    ...
    msg424.send_msg
    msg424.update({updated_at: 8.hours.ago})
...
msg425 = Acon34.messages.create({
    ...
    msg425.send_msg
    msg425.update({updated_at: 8.hours.ago})
...
msg426 = Scon34.messages.create({
    ...
    msg426.send_msg
    msg426.update({updated_at: 7.hours.ago})
...
msg427 = Acon34.messages.create({
    ...
    msg427.send_msg
    msg427.update({updated_at: 7.hours.ago})
...
msg428 = Scon34.messages.create({
    ...
    msg428.send_msg
    msg428.update({updated_at: 7.hours.ago})
...
msg429 = Acon34.messages.create({
    ...
    msg429.send_msg
    msg429.update({updated_at: 7.hours.ago})
...
msg430 = Scon34.messages.create({
    ...
    msg430.send_msg
    msg430.update({updated_at: 7.hours.ago})
...
msg431 = Acon34.messages.create({
    ...
    msg431.send_msg
    msg431.update({updated_at: 7.hours.ago})
      ...
      Scon35 = soc.conversations.create(title: "Has any of the Sophists wronged", meta_conversation: MetCon35)
      Mcon35 = meno.conversations.create(title: "Has any of the Sophists wronged", meta_conversation: MetCon35)
      Bcon35 = boy.conversations.create(title: "Has any of the Sophists wronged", meta_conversation: MetCon35)
      Acon35 = anytus.conversations.create(title: "Has any of the Sophists wronged", meta_conversation: MetCon35 )
...
msg432 = Scon35.messages.create({
    ...
    msg432.send_msg
    msg432.update({updated_at: 7.hours.ago})
...
msg433 = Acon35.messages.create({
    ...
    msg433.send_msg
    msg433.update({updated_at: 7.hours.ago})
...
msg434 = Scon35.messages.create({
    ...
    msg434.send_msg
    msg434.update({updated_at: 7.hours.ago})
...
msg435 = Acon35.messages.create({
    ...
    msg435.send_msg
    msg435.update({updated_at: 7.hours.ago})
...
msg437 = Acon35.messages.create({
    ...
    msg437.update({updated_at: 7.hours.ago})
      ...
      Scon36 = soc.conversations.create(title: "You must be a diviner, Anytus,", meta_conversation: MetCon36)
      Mcon36 = meno.conversations.create(title: "You must be a diviner, Anytus,", meta_conversation: MetCon36)
      Bcon36 = boy.conversations.create(title: "You must be a diviner, Anytus,", meta_conversation: MetCon36)
      Acon36 = anytus.conversations.create(title: "You must be a diviner, Anytus,", meta_conversation: MetCon36 )
...
msg440 = Scon36.messages.create({
    ...
    msg440.send_msg
    msg440.update({updated_at: 6.hours.ago})
...
msg441 = Acon36.messages.create({
    ...
    msg441.send_msg
    msg441.update({updated_at: 6.hours.ago})
...
msg442 = Scon36.messages.create({
    ...
    msg442.send_msg
    msg442.update({updated_at: 6.hours.ago})
...
msg443 = Acon36.messages.create({
    ...
    msg443.send_msg
    msg443.update({updated_at: 6.hours.ago})
...
msg444 = Scon36.messages.create({
    ...
    msg444.send_msg
    msg444.update({updated_at: 6.hours.ago})
...
msg445 = Acon36.messages.create({
    ...
    msg445.send_msg
    msg445.update({updated_at: 6.hours.ago})
...
msg446 = Scon36.messages.create({
    ...
    msg446.send_msg
    msg446.update({updated_at: 6.hours.ago})
...
msg451 = Acon36.messages.create({
    ...
    msg451.send_msg
    msg451.update({updated_at: 5.hours.ago})
...
msg452 = Scon36.messages.create({
    ...
    msg452.send_msg
    msg452.update({updated_at: 5.hours.ago})
...
msg453 = Acon36.messages.create({
    ...
    msg453.send_msg
    msg453.update({updated_at: 5.hours.ago})
...
msg454 = Scon36.messages.create({
    ...
    msg454.send_msg
    msg454.update({updated_at: 5.hours.ago})
...
msg455 = Acon36.messages.create({
    ...
    msg455.send_msg
    msg455.update({updated_at: 5.hours.ago})
...
msg456 = Scon36.messages.create({
    ...
    msg456.send_msg
    msg456.update({updated_at: 5.hours.ago})
...
msg457 = Acon36.messages.create({
    ...
    msg457.send_msg
    msg457.update({updated_at: 5.hours.ago})
...
msg458 = Scon36.messages.create({
    ...
    msg458.send_msg
    msg458.update({updated_at: 5.hours.ago})
...
msg459 = Acon36.messages.create({
    ...
    msg459.send_msg
    msg459.update({updated_at: 5.hours.ago})
...
msg460 = Scon36.messages.create({
    ...
    msg460.send_msg
    msg460.update({updated_at: 5.hours.ago})
...
msg461 = Acon36.messages.create({
    ...
    msg461.send_msg
    msg461.update({updated_at: 4.hours.ago})
...
msg462 = Scon36.messages.create({
    ...
    msg462.send_msg
    msg462.update({updated_at: 4.hours.ago})
...
msg463 = Acon36.messages.create({
    ...
    msg463.send_msg
    msg463.update({updated_at: 4.hours.ago})
...
msg464 = Scon36.messages.create({
    ...
    msg464.send_msg
    msg464.update({updated_at: 4.hours.ago})
...
msg465 = Mcon36.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, anytus#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 4.hours.ago
    })

    msg465.send_msg
    msg465.update({updated_at: 4.hours.ago})
...
msg466 = Scon36.messages.create({
    ...
    msg466.send_msg
    msg466.update({updated_at: 4.hours.ago})
...
msg467 = Mcon36.messages.create({
    ...
    msg467.send_msg
    msg467.update({updated_at: 4.hours.ago})
...
msg468 = Scon36.messages.create({
    ...
    msg468.send_msg
    msg468.update({updated_at: 4.hours.ago})
...
msg469 = Mcon36.messages.create({
    ...
    msg469.send_msg
    msg469.update({updated_at: 4.hours.ago})
...
msg472 = Scon36.messages.create({
    ...
    msg472.send_msg
    msg472.update({updated_at: 3.hours.ago})
...
msg473 = Mcon36.messages.create({
    ...
    msg473.send_msg
    msg473.update({updated_at: 3.hours.ago})
...
msg474 = Scon36.messages.create({
    ...
    msg474.send_msg
    msg474.update({updated_at: 3.hours.ago})
...
msg475 = Mcon36.messages.create({
    ...
    msg475.send_msg
    msg475.update({updated_at: 3.hours.ago})
...
msg476 = Scon36.messages.create({
    ...
    msg476.send_msg
    msg476.update({updated_at: 3.hours.ago})
...
msg477 = Mcon36.messages.create({
    ...
    msg477.send_msg
    msg477.update({updated_at: 3.hours.ago})
...
msg478 = Scon36.messages.create({
    ...
    msg478.send_msg
    msg478.update({updated_at: 3.hours.ago})
...
msg480 = Mcon36.messages.create({
    ...
    msg480.send_msg
    msg480.update({updated_at: 3.hours.ago})
...
msg481 = Scon36.messages.create({
    ...
    msg481.send_msg
    msg481.update({updated_at: 3.hours.ago})
...
msg482 = Mcon36.messages.create({
    ...
    msg482.send_msg
    msg482.update({updated_at: 3.hours.ago})
...
msg483 = Scon36.messages.create({
    ...
    msg483.send_msg
    msg483.update({updated_at: 3.hours.ago})
...
msg484 = Mcon36.messages.create({
    ...
    msg484.send_msg
    msg484.update({updated_at: 3.hours.ago})
...
msg485 = Scon36.messages.create({
    ...
    msg485.send_msg
    msg485.update({updated_at: 2.hours.ago})
...
msg486 = Mcon36.messages.create({
    ...
    msg486.send_msg
    msg486.update({updated_at: 2.hours.ago})
      ...
      Scon37 = soc.conversations.create(title: "And we have admitted that a", meta_conversation: MetCon37)
      Mcon37 = meno.conversations.create(title: "And we have admitted that a", meta_conversation: MetCon37)
      Bcon37 = boy.conversations.create(title: "And we have admitted that a", meta_conversation: MetCon37)
      Acon37 = anytus.conversations.create(title: "And we have admitted that a", meta_conversation: MetCon37 )
...
msg487 = Scon37.messages.create({
    ...
    msg487.send_msg
    msg487.update({updated_at: 2.hours.ago})
...
msg488 = Mcon37.messages.create({
    ...
    msg488.send_msg
    msg488.update({updated_at: 2.hours.ago})
      ...
      Scon38 = soc.conversations.create(title: "And there are no teachers of", meta_conversation: MetCon38)
      Mcon38 = meno.conversations.create(title: "And there are no teachers of", meta_conversation: MetCon38)
      Bcon38 = boy.conversations.create(title: "And there are no teachers of", meta_conversation: MetCon38)
      Acon38 = anytus.conversations.create(title: "And there are no teachers of", meta_conversation: MetCon38 )

body_str = <<-BODY 
 And there are no teachers of virtue to be found anywhere?
BODY

msg489 = Scon38.messages.create({
    source_address: "daemonic#{EMAIL_SIGNATURE}",
    target_address: "anytus#{EMAIL_SIGNATURE}, meno#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 2.hours.ago
    ...
    msg489.send_msg
    msg489.update({updated_at: 2.hours.ago})
...
msg490 = Mcon38.messages.create({
    ...
    msg490.send_msg
    msg490.update({updated_at: 2.hours.ago})
...
msg491 = Scon38.messages.create({
    ...
    msg491.send_msg
    msg491.update({updated_at: 2.hours.ago})
...
msg492 = Mcon38.messages.create({
    ...
    msg492.send_msg
    msg492.update({updated_at: 2.hours.ago})
...
msg493 = Scon38.messages.create({
    ...
    msg493.send_msg
    msg493.update({updated_at: 2.hours.ago})
...
msg494 = Mcon38.messages.create({
    ...
    msg494.send_msg
    msg494.update({updated_at: 2.hours.ago})
...
msg495 = Scon38.messages.create({
    ...
    msg495.send_msg
    msg495.update({updated_at: 2.hours.ago})
...
msg496 = Mcon38.messages.create({
    ...
    msg496.send_msg
    msg496.update({updated_at: 1.hours.ago})
...
msg497 = Scon38.messages.create({
    ...
    msg497.send_msg
    msg497.update({updated_at: 1.hours.ago})
...
msg498 = Mcon38.messages.create({
    ...
    msg498.send_msg
    msg498.update({updated_at: 1.hours.ago})
      ...
      Scon39 = soc.conversations.create(title: "And in supposing that they will", meta_conversation: MetCon39)
      Mcon39 = meno.conversations.create(title: "And in supposing that they will", meta_conversation: MetCon39)
      Bcon39 = boy.conversations.create(title: "And in supposing that they will", meta_conversation: MetCon39)
      Acon39 = anytus.conversations.create(title: "And in supposing that they will", meta_conversation: MetCon39 )
...
msg499 = Scon39.messages.create({
    ...
    msg499.send_msg
    msg499.update({updated_at: 1.hours.ago})
...
msg500 = Mcon39.messages.create({
    ...
    msg500.send_msg
    msg500.update({updated_at: 1.hours.ago})
...
msg501 = Scon39.messages.create({
    ...
    msg501.send_msg
    msg501.update({updated_at: 1.hours.ago})
...
msg502 = Mcon39.messages.create({
    ...
    msg502.send_msg
    msg502.update({updated_at: 1.hours.ago})
...
msg503 = Scon39.messages.create({
    ...
    msg503.send_msg
    msg503.update({updated_at: 1.hours.ago})
...
msg504 = Mcon39.messages.create({
    ...
    msg504.send_msg
    msg504.update({updated_at: 1.hours.ago})
...
msg506 = Mcon39.messages.create({
    ...
    msg506.send_msg
    msg506.update({updated_at: 12.minutes.ago})
...
msg507 = Scon39.messages.create({
    ...
    msg507.send_msg
    msg507.update({updated_at: 11.minutes.ago})
...
msg508 = Mcon39.messages.create({
    ...
    msg508.send_msg
    msg508.update({updated_at: 11.minutes.ago})
...
msg509 = Scon39.messages.create({
    ...
    msg509.send_msg
    msg509.update({updated_at: 11.minutes.ago})
...
msg510 = Mcon39.messages.create({
    ...
    msg510.send_msg
    msg510.update({updated_at: 11.minutes.ago})
...
msg511 = Scon39.messages.create({
    ...
    msg511.send_msg
    msg511.update({updated_at: 11.minutes.ago})
...
msg512 = Mcon39.messages.create({
    ...
    msg512.send_msg
    msg512.update({updated_at: 11.minutes.ago})
...
msg513 = Scon39.messages.create({
    ...
    msg513.send_msg
    msg513.update({updated_at: 11.minutes.ago})
...
msg514 = Mcon39.messages.create({
    ...
    msg514.send_msg
    msg514.update({updated_at: 11.minutes.ago})
...
msg515 = Scon39.messages.create({
    ...
    msg515.send_msg
    msg515.update({updated_at: 11.minutes.ago})
...
msg519 = Scon39.messages.create({
    ...
    msg519.send_msg
    msg519.update({updated_at: 10.minutes.ago})
...
msg520 = Mcon39.messages.create({
    ...
    msg520.send_msg
    msg520.update({updated_at: 10.minutes.ago})
...
msg521 = Scon39.messages.create({
    ...
    msg521.send_msg
    msg521.update({updated_at: 10.minutes.ago})
...
msg522 = Mcon39.messages.create({
    ...
    msg522.send_msg
    msg522.update({updated_at: 10.minutes.ago})
        ...
        Scon39.update({
                             message_timestamp: 10.minutes.ago,
                             read: false
                           }) 
        Mcon39.update({
                             message_timestamp: 10.minutes.ago,
      ...
      Scon40 = soc.conversations.create(title: "I too speak rather in ignorance;", meta_conversation: MetCon40)
      Mcon40 = meno.conversations.create(title: "I too speak rather in ignorance;", meta_conversation: MetCon40)
      Bcon40 = boy.conversations.create(title: "I too speak rather in ignorance;", meta_conversation: MetCon40)
      Acon40 = anytus.conversations.create(title: "I too speak rather in ignorance;", meta_conversation: MetCon40 )
...
msg523 = Scon40.messages.create({
    ...
    msg523.send_msg
    msg523.update({updated_at: 10.minutes.ago})
...
msg524 = Mcon40.messages.create({
    ...
    msg524.send_msg
    msg524.update({updated_at: 10.minutes.ago})
...
msg525 = Scon40.messages.create({
    ...
    msg525.send_msg
    msg525.update({updated_at: 10.minutes.ago})
...
msg526 = Mcon40.messages.create({
    ...
    msg526.send_msg
    msg526.update({updated_at: 10.minutes.ago})
...
msg527 = Scon40.messages.create({
    ...
    msg527.send_msg
    msg527.update({updated_at: 10.minutes.ago})
...
msg531 = Scon40.messages.create({
    ...
    msg531.send_msg
    msg531.update({updated_at: 9.minutes.ago})
...
msg532 = Mcon40.messages.create({
    ...
    msg532.send_msg
    msg532.update({updated_at: 9.minutes.ago})
...
msg533 = Scon40.messages.create({
    ...
    msg533.send_msg
    msg533.update({updated_at: 9.minutes.ago})
...
msg534 = Mcon40.messages.create({
    ...
    msg534.send_msg
    msg534.update({updated_at: 9.minutes.ago})
...
msg535 = Scon40.messages.create({
    ...
    msg535.send_msg
    msg535.update({updated_at: 9.minutes.ago})
...
msg536 = Mcon40.messages.create({
    ...
    msg536.send_msg
    msg536.update({updated_at: 9.minutes.ago})
        ...
        Scon40.update({
                             message_timestamp: 9.minutes.ago,
                             read: false
                           }) 
        Mcon40.update({
                             message_timestamp: 9.minutes.ago,
      ...
      Scon41 = soc.conversations.create(title: "If virtue was wisdom (or knowledge),", meta_conversation: MetCon41)
      Mcon41 = meno.conversations.create(title: "If virtue was wisdom (or knowledge),", meta_conversation: MetCon41)
      Bcon41 = boy.conversations.create(title: "If virtue was wisdom (or knowledge),", meta_conversation: MetCon41)
      Acon41 = anytus.conversations.create(title: "If virtue was wisdom (or knowledge),", meta_conversation: MetCon41 )
...
msg537 = Scon41.messages.create({
    ...
    msg537.send_msg
    msg537.update({updated_at: 9.minutes.ago})
...
msg538 = Mcon41.messages.create({
    ...
    msg538.send_msg
    msg538.update({updated_at: 9.minutes.ago})
...
msg543 = Scon41.messages.create({
    ...
    msg543.update({updated_at: 9.minutes.ago})
      ...
      Scon42 = soc.conversations.create(title: "Yes.", meta_conversation: MetCon42)
      Mcon42 = meno.conversations.create(title: "Yes.", meta_conversation: MetCon42)
      Bcon42 = boy.conversations.create(title: "Yes.", meta_conversation: MetCon42)
      Acon42 = anytus.conversations.create(title: "Yes.", meta_conversation: MetCon42 )

body_str = <<-BODY 
 Yes.
BODY

msg544 = Mcon42.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, anytus#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 9.minutes.ago
...
msg545 = Scon42.messages.create({
    ...
    msg545.send_msg
    msg545.update({updated_at: 8.minutes.ago})
...
msg546 = Mcon42.messages.create({
    ...
    msg546.send_msg
    msg546.update({updated_at: 8.minutes.ago})
...
msg547 = Scon42.messages.create({
    ...
    msg547.send_msg
    msg547.update({updated_at: 8.minutes.ago})
...
msg548 = Mcon42.messages.create({
    ...
    msg548.send_msg
    msg548.update({updated_at: 8.minutes.ago})
...
msg549 = Scon42.messages.create({
    ...
    msg549.send_msg
    msg549.update({updated_at: 8.minutes.ago})
      ...
      Scon43 = soc.conversations.create(title: "Certainly.", meta_conversation: MetCon43)
      Mcon43 = meno.conversations.create(title: "Certainly.", meta_conversation: MetCon43)
      Bcon43 = boy.conversations.create(title: "Certainly.", meta_conversation: MetCon43)
      Acon43 = anytus.conversations.create(title: "Certainly.", meta_conversation: MetCon43 )

body_str = <<-BODY 
 Certainly.
BODY

msg550 = Mcon43.messages.create({
    source_address: "meno#{EMAIL_SIGNATURE}",
    target_address: "daemonic#{EMAIL_SIGNATURE}, anytus#{EMAIL_SIGNATURE}",
    body: body_str,
    created_at: 8.minutes.ago
    ...
    msg550.send_msg
    msg550.update({updated_at: 8.minutes.ago})
...
msg556 = Mcon43.messages.create({
    ...
    msg556.send_msg
    msg556.update({updated_at: 7.minutes.ago})
...
msg557 = Scon43.messages.create({
    ...
    msg557.send_msg
    msg557.update({updated_at: 7.minutes.ago})
...
msg558 = Mcon43.messages.create({
    ...
    msg558.send_msg
    msg558.update({updated_at: 7.minutes.ago})
...
msg559 = Scon43.messages.create({
    ...
    msg559.send_msg
    msg559.update({updated_at: 7.minutes.ago})
...
msg560 = Mcon43.messages.create({
    ...
    msg560.send_msg
    msg560.update({updated_at: 7.minutes.ago})
...
msg561 = Scon43.messages.create({
    ...
    msg561.send_msg
    msg561.update({updated_at: 7.minutes.ago})
...
msg562 = Mcon43.messages.create({
    ...
    msg562.send_msg
    msg562.update({updated_at: 7.minutes.ago})
...
msg563 = Scon43.messages.create({
    ...
    msg563.send_msg
    msg563.update({updated_at: 7.minutes.ago})
...
msg564 = Mcon43.messages.create({
    ...
    msg564.send_msg
    msg564.update({updated_at: 7.minutes.ago})
...
msg565 = Scon43.messages.create({
    ...
    msg565.update({updated_at: 7.minutes.ago})
      ...
      Scon44 = soc.conversations.create(title: "And I think, Socrates, that they", meta_conversation: MetCon44)
      Mcon44 = meno.conversations.create(title: "And I think, Socrates, that they", meta_conversation: MetCon44)
      Bcon44 = boy.conversations.create(title: "And I think, Socrates, that they", meta_conversation: MetCon44)
      Acon44 = anytus.conversations.create(title: "And I think, Socrates, that they", meta_conversation: MetCon44 )
