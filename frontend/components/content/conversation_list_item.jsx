...
var ConversationListItem = React.createClass({
    ...
    toggleImp: function (e) {
        ...
        FlashActions.newMessage("The Conversation has been marked as " + (conversation.important ? "" : "not") + " Important.")
    },


    linkToDetail: function (e) {
        if (e.target.tagName !== "I") {
            if (!this.props.conversation.sent && !this.props.conversation.received) {
                var draft = {};
